...
const Data = [
  ...
  {
    jobtitle: 'Data Engineer Developer',
    openings: 3,
    location: 'Banglore',
    JobId: 200234,
    skill: 3,
              ...
              <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent>
                  ...
                  <Typography paragraph>
                    A person expert in React,Typescrip,.Net with minimum of 2
                    years experience is required.
                  </Typography>
                  <Typography paragraph>
                    Also know how to use git,bitbucket and jira tools and must
                    be familiar with SDLC lifecycles.
                  </Typography>
                </CardContent>
              </Collapse>
            </Card>
